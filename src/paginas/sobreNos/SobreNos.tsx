            ...
            <Grid>
                ...
                <Box className='cards'>
                    ...
                    <div className="cardPerson">
                        <img src="https://i.imgur.com/lAhm8Fu.jpeg" alt="" className="foto" />
                        <div className="textPerson">
                            <p>
                                ...
                                Estou pronto para aprender, trabalhar duro e contribuir com minha equipe. Obrigado por me ouvir, estou ansioso para saber mais sobre as oportunidades disponíveis
                            </p>
                    ...
                    <div className="cardPersonInvert">
                        <img src="https://i.imgur.com/OQRY7Z4.jpeg" alt="" className="foto" />
                        <div className="textPerson">
                            <p>
                            Olá, meu nome é Beatriz e tenho 22 anos. Sou formada em Pedagogia, mas percebi que minha verdadeira paixão é a tecnologia. Por isso, participei de um bootcamp pela Generation Brasil e me tornei uma Desenvolvedora Full Stack Jr.
                                ...
                                Sou uma pessoa curiosa e sempre busco aprender mais sobre a área da tecnologia. Estou pronta para enfrentar novos desafios e sempre dou o meu melhor em tudo o que faço.
                            </p>
                    ...
                    <div className="cardPersonInvert">
                        <img src="https://i.imgur.com/xCHDpav.jpeg" alt="" className="foto" />
                        <div className="textPerson">
                            <p>
                    ...
                    <div className="cardPerson">
                        <img src="https://i.imgur.com/mQ4rawj.jpeg" alt="" className="foto" />
                        <div className="textPerson">
                            <p>
